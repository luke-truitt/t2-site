...
class HomePage extends React.Component {
  ...
  handleSubmit(event) {
    ...
    a.target= '_blank';
    a.href= "mailto:orders@t2ppe.com?subject=I'm Ordering Some Masks!&body=Hello, %0A %0AI'd like to purchase " + String(this.state['quantity']) + " KN-95 masks to help protect myself and those around me. %0A %0A" + this.state['name'] + "%0A" + this.state['email'];
    a.click();
  }
    ...
    return (
      <div>
        ...
        <Container id="order" fluid className="boxShadowed" 
          ...
          <Form style={{paddingLeft: "25%", paddingRight: "25%", justifyContent: "center", alignItems: "center"}} onSubmit={this.handleSubmit}>
            <Form.Group controlId="formName">
              <Form.Label style={{color: "#222222"}}>Name</Form.Label>
              <Form.Control type="text" placeholder="Ex. William Patterson" value={this.state.name} onChange={this.handleNameChange}/>
            </Form.Group>
            ...
            <Form.Group controlId="formQuantity">
              ...
              <Form.Control type="number" placeholder="Ex. 1000" value={this.state.quantity} onChange={this.handleQuantityChange}/>
            </Form.Group>
            <Button variant="secondary" type="submit" style={{backgroundColor: "#628cf0"}}>
              Do your part!
            </Button>
          </Form>
        </Container>
